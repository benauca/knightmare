...
class CameraGroup(pygame.sprite.Group):
    ...
    def __init__(self) -> None:
        ...
        # Offset asociado a la camara. Gestiona como se mueve la camara, que luego usaremos para pintar en los
        # rectangulos de ground y de los sprites activos (Player and Tree)
        ...
        self.ground_surf = pygame.image.load(
            'assets/ground.png').convert_alpha()
